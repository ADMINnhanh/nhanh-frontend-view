...
function main() {
...

  {
    ...
    const texture = loader.load("/public/three/world.jpg", () => render(true));
  ...
  loadFile(
    "/public/three/gpw_v4_basic_demographic_characteristics_rev10_a000_014mt_2010_cntm_1_deg.asc"
  )
    .then(parseData)
    .then(addBoxes)
    .then(() => render(true));
