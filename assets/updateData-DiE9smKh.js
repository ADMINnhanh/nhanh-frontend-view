import{p as v,S as C,Q as d,R as f,ap as y,d as V,v as A,a2 as D,K as G,W as H,k as T,dj as z,J as I,o as h,aS as w,w as o,b as a,u as s,e as l,b4 as B,B as m,aY as k,bm as W,_ as j}from"./index-gVmBTWk7.js";import{N as $}from"./Switch-C_FcSfcZ.js";/* empty css                                                                   */const r="0!important",P="-1px!important";function p(i){return f(`${i}-type`,[d("& +",[v("button",{},[f(`${i}-type`,[y("border",{borderLeftWidth:r}),y("state-border",{left:P})])])])])}function b(i){return f(`${i}-type`,[d("& +",[v("button",[f(`${i}-type`,[y("border",{borderTopWidth:r}),y("state-border",{top:P})])])])])}const K=v("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
