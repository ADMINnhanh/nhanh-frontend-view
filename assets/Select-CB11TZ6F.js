import{ay as Je,cP as Ue,A as be,a9 as fn,d as pe,h as i,cQ as Fe,p as hn,cR as en,af as Ge,T as Un,ar as vn,m as x,an as M,P as U,O as ne,Q as Xe,ao as gn,av as on,a6 as Gn,a8 as qn,R as Yn,q as nn,X as bn,v as Oe,C as j,cS as Qn,I as S,y as P,cT as Xn,$ as Zn,Y as ge,cU as Be,M as ln,D as tn,E as Ie,G as pn,cV as Jn,cW as et,b0 as qe,cX as rn,S as nt,N as tt,cY as ot,W as lt,az as it,aA as rt,aB as at,Z as Ze,aC as st,c9 as dt,aD as an,cZ as ut,V as sn,c_ as ct,z as ft,aG as ht,aI as vt,aE as gt,aJ as bt,F as ee}from"./index-CMHVWPy1.js";import{N as pt}from"./Suffix-BtS4XgYD.js";import{g as dn}from"./attribute-Cz32yFEB.js";import{V as mt,N as wt}from"./Empty-D0nW16-o.js";import{u as yt}from"./use-locale-DStpHQ5z.js";function mn(e,a){a&&(Je(()=>{const{value:s}=e;s&&Ue.registerHandler(s,a)}),be(e,(s,d)=>{d&&Ue.unregisterHandler(d)},{deep:!1}),fn(()=>{const{value:s}=e;s&&Ue.unregisterHandler(s)}))}function Ye(e){const a=e.filter(s=>s!==void 0);if(a.length!==0)return a.length===1?a[0]:s=>{e.forEach(d=>{d&&d(s)})}}const xt=pe({name:"Checkmark",render(){return i("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 16 16"},i("g",{fill:"none"},i("path",{d:"M14.046 3.486a.75.75 0 0 1-.032 1.06l-7.93 7.474a.85.85 0 0 1-1.188-.022l-2.68-2.72a.75.75 0 1 1 1.068-1.053l2.234 2.267l7.468-7.038a.75.75 0 0 1 1.06.032z",fill:"currentColor"})))}}),Ct=pe({props:{onFocus:Function,onBlur:Function},setup(e){return()=>i("div",{style:"width: 0; height: 0",tabindex:0,onFocus:e.onFocus,onBlur:e.onBlur})}}),un=pe({name:"NBaseSelectGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{renderLabelRef:e,renderOptionRef:a,labelFieldRef:s,nodePropsRef:d}=hn(en);return{labelField:s,nodeProps:d,renderLabel:e,renderOption:a}},render(){const{clsPrefix:e,renderLabel:a,renderOption:s,nodeProps:d,tmNode:{rawNode:f}}=this,v=d==null?void 0:d(f),h=a?a(f,!1):Fe(f[this.labelField],f,!1),r=i("div",Object.assign({},v,{class:[`${e}-base-select-group-header`,v==null?void 0:v.class]}),h);return f.render?f.render({node:r,option:f}):s?s({node:r,option:f,selected:!1}):r}});function Ft(e,a){return i(vn,{name:"fade-in-scale-up-transition"},{default:()=>e?i(Un,{clsPrefix:a,class:`${a}-base-select-option__check`},{default:()=>i(xt)}):null})}const cn=pe({name:"NBaseSelectOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(e){const{valueRef:a,pendingTmNodeRef:s,multipleRef:d,valueSetRef:f,renderLabelRef:v,renderOptionRef:h,labelFieldRef:r,valueFieldRef:z,showCheckmarkRef:A,nodePropsRef:F,handleOptionClick:N,handleOptionMouseEnter:R}=hn(en),C=Ge(()=>{const{value:T}=s;return T?e.tmNode.key===T.key:!1});function w(T){const{tmNode:O}=e;O.disabled||N(T,O)}function _(T){const{tmNode:O}=e;O.disabled||R(T,O)}function W(T){const{tmNode:O}=e,{value:k}=C;O.disabled||k||R(T,O)}return{multiple:d,isGrouped:Ge(()=>{const{tmNode:T}=e,{parent:O}=T;return O&&O.rawNode.type==="group"}),showCheckmark:A,nodeProps:F,isPending:C,isSelected:Ge(()=>{const{value:T}=a,{value:O}=d;if(T===null)return!1;const k=e.tmNode.rawNode[z.value];if(O){const{value:D}=f;return D.has(k)}else return T===k}),labelField:r,renderLabel:v,renderOption:h,handleMouseMove:W,handleMouseEnter:_,handleClick:w}},render(){const{clsPrefix:e,tmNode:{rawNode:a},isSelected:s,isPending:d,isGrouped:f,showCheckmark:v,nodeProps:h,renderOption:r,renderLabel:z,handleClick:A,handleMouseEnter:F,handleMouseMove:N}=this,R=Ft(s,e),C=z?[z(a,s),v&&R]:[Fe(a[this.labelField],a,s),v&&R],w=h==null?void 0:h(a),_=i("div",Object.assign({},w,{class:[`${e}-base-select-option`,a.class,w==null?void 0:w.class,{[`${e}-base-select-option--disabled`]:a.disabled,[`${e}-base-select-option--selected`]:s,[`${e}-base-select-option--grouped`]:f,[`${e}-base-select-option--pending`]:d,[`${e}-base-select-option--show-checkmark`]:v}],style:[(w==null?void 0:w.style)||"",a.style||""],onClick:Ye([A,w==null?void 0:w.onClick]),onMouseenter:Ye([F,w==null?void 0:w.onMouseenter]),onMousemove:Ye([N,w==null?void 0:w.onMousemove])}),i("div",{class:`${e}-base-select-option__content`},C));return a.render?a.render({node:_,option:a,selected:s}):r?r({node:_,option:a,selected:s}):_}}),Ot=x("base-select-menu",`
 line-height: 1.5;
 outline: none;
 z-index: 0;
 position: relative;
