...
`,[o(">",[s("clear",`
 ...
 `,[f({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),x=n({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(l){return h("-base-clear",v,C(l,"clsPrefix")),{handleMouseDown(r){r.preventDefault()}}},render(){const{clsPrefix:l}=this;return e("div",{class:`${l}-base-clear`},e(u,null,{default:()=>{var r,a;return this.show?e("div",{key:"dismiss",class:`${l}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},t(this.$slots.icon,()=>[e(i,{clsPrefix:l},{default:()=>e(L,null)})])):e("div",{key:"icon",class:`${l}-base-clear__placeholder`},(a=(r=this.$slots).placeholder)===null||a===void 0?void 0:a.call(r))}}))}}),g=n({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(l,{slots:r}){return()=>{const{clsPrefix:a}=l;return e(w,{clsPrefix:a,class:`${a}-base-suffix`,strokeWidth:24,scale:.85,show:l.loading},{default:()=>l.showArrow?e(x,{clsPrefix:a,show:l.showClear,onClear:l.onClear},{placeholder:()=>e(i,{clsPrefix:a,class:`${a}-base-suffix__arrow`},{default:()=>t(r.default,()=>[e(p,null)])})}):null})}}});export{p as C,g as N,x as a};
