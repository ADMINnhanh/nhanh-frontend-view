...
`,[t("children-placeholder",`
 ...
 cursor: not-allowed;
 opacity: .5;
 `)])]),pe=Object.assign(Object.assign({},F.props),{size:{type:String,default:"medium"},value:{type:[String,Number,Boolean],default:void 0},loading:Boolean,defaultValue:{type:[String,Number,Boolean],default:!1},disabled:{type:Boolean,default:void 0},round:{type:Boolean,default:!0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],checkedValue:{type:[String,Number,Boolean],default:!0},uncheckedValue:{type:[String,Number,Boolean],default:!1},railStyle:Function,rubberBand:{type:Boolean,default:!0},onChange:[Function,Array]});let S;const Ce=L({name:"Switch",props:pe,setup(e){S===void 0&&(typeof CSS<"u"?typeof CSS.supports<"u"?S=CSS.supports("width","max(1px)"):S=!1:S=!0);const{mergedClsPrefixRef:v,inlineThemeDisabled:d}=X(e),k=F("Switch","-switch",we,ue,e,v),a=he(e),{mergedSizeRef:r,mergedDisabledRef:s}=a,g=W(e.defaultValue),V=be(e,"value"),m=fe(V,g),C=R(()=>m.value===e.checkedValue),y=W(!1),i=W(!1),u=R(()=>{const{railStyle:n}=e;if(n)return n({focused:i.value,checked:C.value})});function h(n){const{"onUpdate:value":z,onChange:B,onUpdateValue:_}=e,{nTriggerFormInput:T,nTriggerFormChange:P}=a;z&&M(z,n),_&&M(_,n),B&&M(B,n),g.value=n,T(),P()}function G(){const{nTriggerFormFocus:n}=a;n()}function J(){const{nTriggerFormBlur:n}=a;n()}function q(){e.loading||s.value||(m.value!==e.checkedValue?h(e.checkedValue):h(e.uncheckedValue))}function Q(){i.value=!0,G()}function Z(){i.value=!1,J(),y.value=!1}function ee(n){e.loading||s.value||n.key===" "&&(m.value!==e.checkedValue?h(e.checkedValue):h(e.uncheckedValue),y.value=!1)}function te(n){e.loading||s.value||n.key===" "&&(n.preventDefault(),y.value=!0)}const E=R(()=>{const{value:n}=r,{self:{opacityDisabled:z,railColor:B,railColorActive:_,buttonBoxShadow:T,buttonColor:P,boxShadowFocus:ne,loadingColor:ie,textColor:oe,iconColor:ae,[w("buttonHeight",n)]:b,[w("buttonWidth",n)]:re,[w("buttonWidthPressed",n)]:se,[w("railHeight",n)]:f,[w("railWidth",n)]:$,[w("railBorderRadius",n)]:le,[w("buttonBorderRadius",n)]:ce},common:{cubicBezierEaseInOut:de}}=k.value;let N,D,j;return S?(N=`calc((${f} - ${b}) / 2)`,D=`max(${f}, ${b})`,j=`max(${$}, calc(${$} + ${b} - ${f}))`):(N=A((c(f)-c(b))/2),D=A(Math.max(c(f),c(b))),j=c(f)>c(b)?$:A(c($)+c(b)-c(f))),{"--n-bezier":de,"--n-button-border-radius":ce,"--n-button-box-shadow":T,"--n-button-color":P,"--n-button-width":re,"--n-button-width-pressed":se,"--n-button-height":b,"--n-height":D,"--n-offset":N,"--n-opacity-disabled":z,"--n-rail-border-radius":le,"--n-rail-color":B,"--n-rail-color-active":_,"--n-rail-height":f,"--n-rail-width":$,"--n-width":j,"--n-box-shadow-focus":ne,"--n-loading-color":ie,"--n-text-color":oe,"--n-icon-color":ae}}),x=d?Y("switch",R(()=>r.value[0]),E,e):void 0;return{handleClick:q,handleBlur:Z,handleFocus:Q,handleKeyup:ee,handleKeydown:te,mergedRailStyle:u,pressed:y,mergedClsPrefix:v,mergedValue:m,checked:C,mergedDisabled:s,cssVars:d?void 0:E,themeClass:x==null?void 0:x.themeClass,onRender:x==null?void 0:x.onRender}},render(){const{mergedClsPrefix:e,mergedDisabled:v,checked:d,mergedRailStyle:k,onRender:a,$slots:r}=this;a==null||a();const{checked:s,unchecked:g,icon:V,"checked-icon":m,"unchecked-icon":C}=r,y=!(H(V)&&H(m)&&H(C));return o("div",{role:"switch","aria-checked":d,class:[`${e}-switch`,this.themeClass,y&&`${e}-switch--icon`,d&&`${e}-switch--active`,v&&`${e}-switch--disabled`,this.round&&`${e}-switch--round`,this.loading&&`${e}-switch--loading`,this.pressed&&`${e}-switch--pressed`,this.rubberBand&&`${e}-switch--rubber-band`],tabindex:this.mergedDisabled?void 0:0,style:this.cssVars,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},o("div",{class:`${e}-switch__rail`,"aria-hidden":"true",style:k},p(s,i=>p(g,u=>i||u?o("div",{"aria-hidden":!0,class:`${e}-switch__children-placeholder`},o("div",{class:`${e}-switch__rail-placeholder`},o("div",{class:`${e}-switch__button-placeholder`}),i),o("div",{class:`${e}-switch__rail-placeholder`},o("div",{class:`${e}-switch__button-placeholder`}),u)):null)),o("div",{class:`${e}-switch__button`},p(V,i=>p(m,u=>p(C,h=>o(ve,null,{default:()=>this.loading?o(ge,{key:"loading",clsPrefix:e,strokeWidth:20}):this.checked&&(u||i)?o("div",{class:`${e}-switch__button-icon`,key:u?"checked-icon":"icon"},u||i):!this.checked&&(h||i)?o("div",{class:`${e}-switch__button-icon`,key:h?"unchecked-icon":"icon"},h||i):null})))),p(s,i=>i&&o("div",{key:"checked",class:`${e}-switch__checked`},i)),p(g,i=>i&&o("div",{key:"unchecked",class:`${e}-switch__unchecked`},i)))))}}),ye=U("a",`
 cursor: pointer;
 transition:
