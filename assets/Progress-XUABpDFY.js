import{d as B,G as m,cA as A,h as r,$ as W,bP as j,bN as O,bM as q,bO as G,a7 as k,V as z,z as a,W as w,D as M,E as T,cB as L,a4 as D,K as X}from"./index-Bknjf2zs.js";const Y={success:r(G,null),error:r(q,null),warning:r(O,null),info:r(j,null)},_=B({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:u}){const g=m(()=>{const o="gradient",{fillColor:t}=e;return typeof t=="object"?`${o}-${A(JSON.stringify(t))}`:o});function y(o,t,n,d){const{gapDegree:p,viewBoxWidth:f,strokeWidth:h}=e,l=50,b=0,s=l,i=0,x=2*l,$=50+h/2,v=`M ${$},${$} m ${b},${s}
      a ${l},${l} 0 1 1 ${i},${-x}
