import{d as B,x as b,ci as A,h as r,Y as W,cj as j,ck as q,cl as O,cm as G,a0 as k,O as z,m as a,P as w,p as L,q as T,cn as M,V as D,D as X}from"./index-DRU1KIa-.js";const Y={success:r(j,null),error:r(q,null),warning:r(O,null),info:r(G,null)},_=B({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:u}){const g=b(()=>{const o="gradient",{fillColor:t}=e;return typeof t=="object"?`${o}-${A(JSON.stringify(t))}`:o});function y(o,t,n,d){const{gapDegree:p,viewBoxWidth:f,strokeWidth:h}=e,l=50,m=0,s=l,i=0,x=2*l,$=50+h/2,v=`M ${$},${$} m ${m},${s}
      a ${l},${l} 0 1 1 ${i},${-x}
