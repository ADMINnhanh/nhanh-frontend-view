import{aF as Ze,cW as Ue,I as be,ag as fn,d as pe,h as i,cX as Fe,C as hn,cY as en,am as Ge,$ as Un,ay as vn,z as x,au as M,W as U,V as ne,X as Qe,av as gn,aC as on,ad as Gn,af as qn,Y as Yn,D as nn,a3 as bn,E as Oe,J as j,cZ as Jn,Q as S,G as P,c_ as Qn,a6 as Xn,a4 as ge,c$ as Ie,U as ln,K as tn,L as Be,N as pn,d0 as Zn,d1 as et,b7 as qe,d2 as rn,Z as nt,O as tt,d3 as ot,a2 as lt,aG as it,aH as rt,aI as at,a5 as Xe,aJ as st,b_ as dt,aK as an,d4 as ut,a1 as sn,d5 as ct,H as ft,aN as ht,aP as vt,aL as gt,aQ as bt,M as ee}from"./index-C3drNslq.js";import{N as pt}from"./Suffix-BATODfaL.js";import{g as dn}from"./attribute-Cz32yFEB.js";import{V as mt,N as wt}from"./Empty-BxntzAWg.js";import{u as yt}from"./use-locale-2k8Ty2jw.js";function mn(e,a){a&&(Ze(()=>{const{value:s}=e;s&&Ue.registerHandler(s,a)}),be(e,(s,d)=>{d&&Ue.unregisterHandler(d)},{deep:!1}),fn(()=>{const{value:s}=e;s&&Ue.unregisterHandler(s)}))}function Ye(e){const a=e.filter(s=>s!==void 0);if(a.length!==0)return a.length===1?a[0]:s=>{e.forEach(d=>{d&&d(s)})}}const xt=pe({name:"Checkmark",render(){return i("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 16 16"},i("g",{fill:"none"},i("path",{d:"M14.046 3.486a.75.75 0 0 1-.032 1.06l-7.93 7.474a.85.85 0 0 1-1.188-.022l-2.68-2.72a.75.75 0 1 1 1.068-1.053l2.234 2.267l7.468-7.038a.75.75 0 0 1 1.06.032z",fill:"currentColor"})))}}),Ct=pe({props:{onFocus:Function,onBlur:Function},setup(e){return()=>i("div",{style:"width: 0; height: 0",tabindex:0,onFocus:e.onFocus,onBlur:e.onBlur})}}),un=pe({name:"NBaseSelectGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{renderLabelRef:e,renderOptionRef:a,labelFieldRef:s,nodePropsRef:d}=hn(en);return{labelField:s,nodeProps:d,renderLabel:e,renderOption:a}},render(){const{clsPrefix:e,renderLabel:a,renderOption:s,nodeProps:d,tmNode:{rawNode:f}}=this,v=d==null?void 0:d(f),h=a?a(f,!1):Fe(f[this.labelField],f,!1),r=i("div",Object.assign({},v,{class:[`${e}-base-select-group-header`,v==null?void 0:v.class]}),h);return f.render?f.render({node:r,option:f}):s?s({node:r,option:f,selected:!1}):r}});function Ft(e,a){return i(vn,{name:"fade-in-scale-up-transition"},{default:()=>e?i(Un,{clsPrefix:a,class:`${a}-base-select-option__check`},{default:()=>i(xt)}):null})}const cn=pe({name:"NBaseSelectOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(e){const{valueRef:a,pendingTmNodeRef:s,multipleRef:d,valueSetRef:f,renderLabelRef:v,renderOptionRef:h,labelFieldRef:r,valueFieldRef:z,showCheckmarkRef:N,nodePropsRef:F,handleOptionClick:A,handleOptionMouseEnter:R}=hn(en),C=Ge(()=>{const{value:T}=s;return T?e.tmNode.key===T.key:!1});function w(T){const{tmNode:O}=e;O.disabled||A(T,O)}function _(T){const{tmNode:O}=e;O.disabled||R(T,O)}function W(T){const{tmNode:O}=e,{value:k}=C;O.disabled||k||R(T,O)}return{multiple:d,isGrouped:Ge(()=>{const{tmNode:T}=e,{parent:O}=T;return O&&O.rawNode.type==="group"}),showCheckmark:N,nodeProps:F,isPending:C,isSelected:Ge(()=>{const{value:T}=a,{value:O}=d;if(T===null)return!1;const k=e.tmNode.rawNode[z.value];if(O){const{value:D}=f;return D.has(k)}else return T===k}),labelField:r,renderLabel:v,renderOption:h,handleMouseMove:W,handleMouseEnter:_,handleClick:w}},render(){const{clsPrefix:e,tmNode:{rawNode:a},isSelected:s,isPending:d,isGrouped:f,showCheckmark:v,nodeProps:h,renderOption:r,renderLabel:z,handleClick:N,handleMouseEnter:F,handleMouseMove:A}=this,R=Ft(s,e),C=z?[z(a,s),v&&R]:[Fe(a[this.labelField],a,s),v&&R],w=h==null?void 0:h(a),_=i("div",Object.assign({},w,{class:[`${e}-base-select-option`,a.class,w==null?void 0:w.class,{[`${e}-base-select-option--disabled`]:a.disabled,[`${e}-base-select-option--selected`]:s,[`${e}-base-select-option--grouped`]:f,[`${e}-base-select-option--pending`]:d,[`${e}-base-select-option--show-checkmark`]:v}],style:[(w==null?void 0:w.style)||"",a.style||""],onClick:Ye([N,w==null?void 0:w.onClick]),onMouseenter:Ye([F,w==null?void 0:w.onMouseenter]),onMousemove:Ye([A,w==null?void 0:w.onMousemove])}),i("div",{class:`${e}-base-select-option__content`},C));return a.render?a.render({node:_,option:a,selected:s}):r?r({node:_,option:a,selected:s}):_}}),Ot=x("base-select-menu",`
 line-height: 1.5;
 outline: none;
 z-index: 0;
 position: relative;
