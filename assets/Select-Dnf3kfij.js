import{q as Xe,cB as Ue,A as be,s as fn,d as pe,l as i,cC as Oe,f as hn,cD as en,z as Ge,aZ as Un,aQ as vn,j as x,J as M,k as U,I as ne,H as Ye,bX as gn,bf as on,cE as Gn,S as qn,C as Jn,m as nn,al as bn,L as Fe,y as j,cF as Qn,p as S,g as P,cG as Yn,ch as Zn,U as ge,cH as Be,E as ln,N as tn,cI as Ie,G as pn,cJ as Xn,cK as et,as as qe,cL as rn,R as nt,bu as tt,cM as ot,aS as lt,bY as it,bZ as rt,b_ as at,b$ as Ze,aO as st,aP as dt,c0 as an,cN as ut,aR as sn,cO as ct,cP as ft,c1 as ht,c3 as vt,aV as gt,cQ as bt,b2 as ee}from"./index-DD6qW7KS.js";import{N as pt}from"./Suffix-CjPriApa.js";import{g as dn}from"./attribute-Cz32yFEB.js";import{V as mt,N as wt}from"./Empty-zQTw_rq0.js";import{u as yt}from"./use-locale-CiNvQx-L.js";function mn(e,a){a&&(Xe(()=>{const{value:s}=e;s&&Ue.registerHandler(s,a)}),be(e,(s,d)=>{d&&Ue.unregisterHandler(d)},{deep:!1}),fn(()=>{const{value:s}=e;s&&Ue.unregisterHandler(s)}))}function Je(e){const a=e.filter(s=>s!==void 0);if(a.length!==0)return a.length===1?a[0]:s=>{e.forEach(d=>{d&&d(s)})}}const xt=pe({name:"Checkmark",render(){return i("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 16 16"},i("g",{fill:"none"},i("path",{d:"M14.046 3.486a.75.75 0 0 1-.032 1.06l-7.93 7.474a.85.85 0 0 1-1.188-.022l-2.68-2.72a.75.75 0 1 1 1.068-1.053l2.234 2.267l7.468-7.038a.75.75 0 0 1 1.06.032z",fill:"currentColor"})))}}),Ct=pe({props:{onFocus:Function,onBlur:Function},setup(e){return()=>i("div",{style:"width: 0; height: 0",tabindex:0,onFocus:e.onFocus,onBlur:e.onBlur})}}),un=pe({name:"NBaseSelectGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{renderLabelRef:e,renderOptionRef:a,labelFieldRef:s,nodePropsRef:d}=hn(en);return{labelField:s,nodeProps:d,renderLabel:e,renderOption:a}},render(){const{clsPrefix:e,renderLabel:a,renderOption:s,nodeProps:d,tmNode:{rawNode:f}}=this,v=d==null?void 0:d(f),h=a?a(f,!1):Oe(f[this.labelField],f,!1),r=i("div",Object.assign({},v,{class:[`${e}-base-select-group-header`,v==null?void 0:v.class]}),h);return f.render?f.render({node:r,option:f}):s?s({node:r,option:f,selected:!1}):r}});function Ot(e,a){return i(vn,{name:"fade-in-scale-up-transition"},{default:()=>e?i(Un,{clsPrefix:a,class:`${a}-base-select-option__check`},{default:()=>i(xt)}):null})}const cn=pe({name:"NBaseSelectOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(e){const{valueRef:a,pendingTmNodeRef:s,multipleRef:d,valueSetRef:f,renderLabelRef:v,renderOptionRef:h,labelFieldRef:r,valueFieldRef:k,showCheckmarkRef:E,nodePropsRef:O,handleOptionClick:A,handleOptionMouseEnter:R}=hn(en),C=Ge(()=>{const{value:T}=s;return T?e.tmNode.key===T.key:!1});function w(T){const{tmNode:F}=e;F.disabled||A(T,F)}function _(T){const{tmNode:F}=e;F.disabled||R(T,F)}function W(T){const{tmNode:F}=e,{value:z}=C;F.disabled||z||R(T,F)}return{multiple:d,isGrouped:Ge(()=>{const{tmNode:T}=e,{parent:F}=T;return F&&F.rawNode.type==="group"}),showCheckmark:E,nodeProps:O,isPending:C,isSelected:Ge(()=>{const{value:T}=a,{value:F}=d;if(T===null)return!1;const z=e.tmNode.rawNode[k.value];if(F){const{value:D}=f;return D.has(z)}else return T===z}),labelField:r,renderLabel:v,renderOption:h,handleMouseMove:W,handleMouseEnter:_,handleClick:w}},render(){const{clsPrefix:e,tmNode:{rawNode:a},isSelected:s,isPending:d,isGrouped:f,showCheckmark:v,nodeProps:h,renderOption:r,renderLabel:k,handleClick:E,handleMouseEnter:O,handleMouseMove:A}=this,R=Ot(s,e),C=k?[k(a,s),v&&R]:[Oe(a[this.labelField],a,s),v&&R],w=h==null?void 0:h(a),_=i("div",Object.assign({},w,{class:[`${e}-base-select-option`,a.class,w==null?void 0:w.class,{[`${e}-base-select-option--disabled`]:a.disabled,[`${e}-base-select-option--selected`]:s,[`${e}-base-select-option--grouped`]:f,[`${e}-base-select-option--pending`]:d,[`${e}-base-select-option--show-checkmark`]:v}],style:[(w==null?void 0:w.style)||"",a.style||""],onClick:Je([E,w==null?void 0:w.onClick]),onMouseenter:Je([O,w==null?void 0:w.onMouseenter]),onMousemove:Je([A,w==null?void 0:w.onMousemove])}),i("div",{class:`${e}-base-select-option__content`},C));return a.render?a.render({node:_,option:a,selected:s}):r?r({node:_,option:a,selected:s}):_}}),Ft=x("base-select-menu",`
 line-height: 1.5;
 outline: none;
 z-index: 0;
 position: relative;
