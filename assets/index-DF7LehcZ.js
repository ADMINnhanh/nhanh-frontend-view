import{d as se,bl as vn,bm as hn,L as nt,bn as Kn,bo as pn,x as W,F as O,a3 as ft,b0 as pt,a$ as st,n as r,N as Ht,ab as Ye,bp as Ze,aN as Un,bq as Gt,aH as gn,br as qn,bs as gt,bt as Gn,f as c,j as N,h as Z,k as ot,s as ye,bu as Xn,V as it,bv as Yn,y as de,z as at,ac as Vt,bw as Kt,bx as Ae,aC as mn,i as P,g as tt,au as xn,m as yn,a0 as ne,by as Zn,bz as Jn,K as $e,ad as Je,a6 as Fe,p as At,a7 as mt,b3 as Qn,a9 as eo,a8 as to,bA as Qe,bB as no,bC as oo,a5 as wn,bD as io,bf as Pt,bE as Xt,bF as ao,aa as et,bG as lo,a1 as Nt,A as Wt,bH as ro,a2 as so,aw as co,ax as Dt,az as uo,aA as fo,aB as bo,aD as Cn,aK as Sn,aE as Yt,ay as vo,bI as ho,af as ge,bJ as po,bK as go,aM as mo,U as xo,aS as yo,bL as wo,bM as Co,bN as So,bO as kt,bP as Ro,bQ as To,bR as zo,o as ze,c as Ne,C as Ie,bS as bt,u as G,bT as _o,_ as Ut,a as re,w as ie,O as vt,Q as ht,bU as Po,be as Ot,bV as ko,e as Ge,t as Xe,S as dt,bW as Oo,bX as Fo,ba as Zt,bY as $o,B as ct,bZ as Mo,b_ as Io,P as Bo,b$ as Eo}from"./index-9JAOTP29.js";import Ft from"./setItem-BcdHw5LC.js";import{I as Lo}from"./Interface text-DsI5FaAk.js";import{u as Rn,a as Ao,A as No}from"./Suffix-qxw5l56v.js";import{A as Wo}from"./Add-CW-ZYpU1.js";function Jt(e){switch(typeof e){case"string":return e||void 0;case"number":return String(e);default:return}}function $t(e){const t=e.filter(n=>n!==void 0);if(t.length!==0)return t.length===1?t[0]:n=>{e.forEach(l=>{l&&l(n)})}}function Qt(e){return e&-e}class Do{constructor(t,n){this.l=t,this.min=n;const l=new Array(t+1);for(let i=0;i<t+1;++i)l[i]=0;this.ft=l}add(t,n){if(n===0)return;const{l,ft:i}=this;for(t+=1;t<=l;)i[t]+=n,t+=Qt(t)}get(t){return this.sum(t+1)-this.sum(t)}sum(t){if(t===void 0&&(t=this.l),t<=0)return 0;const{ft:n,min:l,l:i}=this;if(t>i)throw new Error("[FinweckTree.sum]: `i` is larger than length.");let s=t*l;for(;t>0;)s+=n[t],t-=Qt(t);return s}getBound(t){let n=0,l=this.l;for(;l>n;){const i=Math.floor((n+l)/2),s=this.sum(i);if(s>t){l=i;continue}else if(s<t){if(n===i)return this.sum(n+1)<=t?n+1:i;n=i}else return i}return n}}let ut;function jo(){return typeof document>"u"?!1:(ut===void 0&&("matchMedia"in window?ut=window.matchMedia("(pointer:coarse)").matches:ut=!1),ut)}let Mt;function en(){return typeof document>"u"?1:(Mt===void 0&&(Mt="chrome"in window?window.devicePixelRatio:1),Mt)}const Ho=Ze(".v-vl",{maxHeight:"inherit",height:"100%",overflow:"auto",minWidth:"1px"},[Ze("&:not(.v-vl--show-scrollbar)",{scrollbarWidth:"none"},[Ze("&::-webkit-scrollbar, &::-webkit-scrollbar-track-piece, &::-webkit-scrollbar-thumb",{width:0,height:0,display:"none"})])]),Vo=se({name:"VirtualList",inheritAttrs:!1,props:{showScrollbar:{type:Boolean,default:!0},items:{type:Array,default:()=>[]},itemSize:{type:Number,required:!0},itemResizable:Boolean,itemsStyle:[String,Object],visibleItemsTag:{type:[String,Object],default:"div"},visibleItemsProps:Object,ignoreItemResize:Boolean,onScroll:Function,onWheel:Function,onResize:Function,defaultScrollKey:[Number,String],defaultScrollIndex:Number,keyField:{type:String,default:"key"},paddingTop:{type:[Number,String],default:0},paddingBottom:{type:[Number,String],default:0}},setup(e){const t=vn();Ho.mount({id:"vueuc/virtual-list",head:!0,anchorMetaName:hn,ssr:t}),nt(()=>{const{defaultScrollIndex:C,defaultScrollKey:M}=e;C!=null?T({index:C}):M!=null&&T({key:M})});let n=!1,l=!1;Kn(()=>{if(n=!1,!l){l=!0;return}T({top:k.value,left:p})}),pn(()=>{n=!0,l||(l=!0)});const i=W(()=>{const C=new Map,{keyField:M}=e;return e.items.forEach((E,Y)=>{C.set(E[M],Y)}),C}),s=O(null),u=O(void 0),a=new Map,g=W(()=>{const{items:C,itemSize:M,keyField:E}=e,Y=new Do(C.length,M);return C.forEach((q,Q)=>{const ee=q[E],te=a.get(ee);te!==void 0&&Y.add(Q,te)}),Y}),h=O(0);let p=0;const k=O(0),B=ft(()=>Math.max(g.value.getBound(k.value-pt(e.paddingTop))-1,0)),z=W(()=>{const{value:C}=u;if(C===void 0)return[];const{items:M,itemSize:E}=e,Y=B.value,q=Math.min(Y+Math.ceil(C/E+1),M.length-1),Q=[];for(let ee=Y;ee<=q;++ee)Q.push(M[ee]);return Q}),T=(C,M)=>{if(typeof C=="number"){w(C,M,"auto");return}const{left:E,top:Y,index:q,key:Q,position:ee,behavior:te,debounce:ce=!0}=C;if(E!==void 0||Y!==void 0)w(E,Y,te);else if(q!==void 0)S(q,te,ce);else if(Q!==void 0){const ae=i.value.get(Q);ae!==void 0&&S(ae,te,ce)}else ee==="bottom"?w(0,Number.MAX_SAFE_INTEGER,te):ee==="top"&&w(0,0,te)};let F,y=null;function S(C,M,E){const{value:Y}=g,q=Y.sum(C)+pt(e.paddingTop);if(!E)s.value.scrollTo({left:0,top:q,behavior:M});else{F=C,y!==null&&window.clearTimeout(y),y=window.setTimeout(()=>{F=void 0,y=null},16);const{scrollTop:Q,offsetHeight:ee}=s.value;if(q>Q){const te=Y.get(C);q+te<=Q+ee||s.value.scrollTo({left:0,top:q+te-ee,behavior:M})}else s.value.scrollTo({left:0,top:q,behavior:M})}}function w(C,M,E){s.value.scrollTo({left:C,top:M,behavior:E})}function j(C,M){var E,Y,q;if(n||e.ignoreItemResize||ve(M.target))return;const{value:Q}=g,ee=i.value.get(C),te=Q.get(ee),ce=(q=(Y=(E=M.borderBoxSize)===null||E===void 0?void 0:E[0])===null||Y===void 0?void 0:Y.blockSize)!==null&&q!==void 0?q:M.contentRect.height;if(ce===te)return;ce-e.itemSize===0?a.delete(C):a.set(C,ce-e.itemSize);const ue=ce-te;if(ue===0)return;Q.add(ee,ue);const v=s.value;if(v!=null){if(F===void 0){const R=Q.sum(ee);v.scrollTop>R&&v.scrollBy(0,ue)}else if(ee<F)v.scrollBy(0,ue);else if(ee===F){const R=Q.sum(ee);ce+R>v.scrollTop+v.offsetHeight&&v.scrollBy(0,ue)}be()}h.value++}const D=!jo();let $=!1;function L(C){var M;(M=e.onScroll)===null||M===void 0||M.call(e,C),(!D||!$)&&be()}function X(C){var M;if((M=e.onWheel)===null||M===void 0||M.call(e,C),D){const E=s.value;if(E!=null){if(C.deltaX===0&&(E.scrollTop===0&&C.deltaY<=0||E.scrollTop+E.offsetHeight>=E.scrollHeight&&C.deltaY>=0))return;C.preventDefault(),E.scrollTop+=C.deltaY/en(),E.scrollLeft+=C.deltaX/en(),be(),$=!0,Un(()=>{$=!1})}}}function fe(C){if(n||ve(C.target)||C.contentRect.height===u.value)return;u.value=C.contentRect.height;const{onResize:M}=e;M!==void 0&&M(C)}function be(){const{value:C}=s;C!=null&&(k.value=C.scrollTop,p=C.scrollLeft)}function ve(C){let M=C;for(;M!==null;){if(M.style.display==="none")return!0;M=M.parentElement}return!1}return{listHeight:u,listStyle:{overflow:"auto"},keyToIndex:i,itemsStyle:W(()=>{const{itemResizable:C}=e,M=st(g.value.sum());return h.value,[e.itemsStyle,{boxSizing:"content-box",height:C?"":M,minHeight:C?M:"",paddingTop:st(e.paddingTop),paddingBottom:st(e.paddingBottom)}]}),visibleItemsStyle:W(()=>(h.value,{transform:`translateY(${st(g.value.sum(B.value))})`})),viewportItems:z,listElRef:s,itemsElRef:O(null),scrollTo:T,handleListResize:fe,handleListScroll:L,handleListWheel:X,handleItemResize:j}},render(){const{itemResizable:e,keyField:t,keyToIndex:n,visibleItemsTag:l}=this;return r(Ye,{onResize:this.handleListResize},{default:()=>{var i,s;return r("div",Ht(this.$attrs,{class:["v-vl",this.showScrollbar&&"v-vl--show-scrollbar"],onScroll:this.handleListScroll,onWheel:this.handleListWheel,ref:"listElRef"}),[this.items.length!==0?r("div",{ref:"itemsElRef",class:"v-vl-items",style:this.itemsStyle},[r(l,Object.assign({class:"v-vl-visible-items",style:this.visibleItemsStyle},this.visibleItemsProps),{default:()=>this.viewportItems.map(u=>{const a=u[t],g=n.get(a),h=this.$slots.default({item:u,index:g})[0];return e?r(Ye,{key:a,onResize:p=>this.handleItemResize(a,p)},{default:()=>h}):(h.key=a,h)})})]):(s=(i=this.$slots).empty)===null||s===void 0?void 0:s.call(i)])}})}}),Ko=Ze(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[Ze("&::-webkit-scrollbar",{width:0,height:0})]),Uo=se({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=O(null);function t(i){!(i.currentTarget.offsetWidth<i.currentTarget.scrollWidth)||i.deltaY===0||(i.currentTarget.scrollLeft+=i.deltaY+i.deltaX,i.preventDefault())}const n=vn();return Ko.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:hn,ssr:n}),Object.assign({selfRef:e,handleWheel:t},{scrollTo(...i){var s;(s=e.value)===null||s===void 0||s.scrollTo(...i)}})},render(){return r("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});function Tn(e,t){t&&(nt(()=>{const{value:n}=e;n&&Gt.registerHandler(n,t)}),gn(()=>{const{value:n}=e;n&&Gt.unregisterHandler(n)}))}var qo=/\s/;function Go(e){for(var t=e.length;t--&&qo.test(e.charAt(t)););return t}var Xo=/^\s+/;function Yo(e){return e&&e.slice(0,Go(e)+1).replace(Xo,"")}var tn=NaN,Zo=/^[-+]0x[0-9a-f]+$/i,Jo=/^0b[01]+$/i,Qo=/^0o[0-7]+$/i,ei=parseInt;function nn(e){if(typeof e=="number")return e;if(qn(e))return tn;if(gt(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=gt(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=Yo(e);var n=Jo.test(e);return n||Qo.test(e)?ei(e.slice(2),n?2:8):Zo.test(e)?tn:+e}var It=function(){return Gn.Date.now()},ti="Expected a function",ni=Math.max,oi=Math.min;function ii(e,t,n){var l,i,s,u,a,g,h=0,p=!1,k=!1,B=!0;if(typeof e!="function")throw new TypeError(ti);t=nn(t)||0,gt(n)&&(p=!!n.leading,k="maxWait"in n,s=k?ni(nn(n.maxWait)||0,t):s,B="trailing"in n?!!n.trailing:B);function z(L){var X=l,fe=i;return l=i=void 0,h=L,u=e.apply(fe,X),u}function T(L){return h=L,a=setTimeout(S,t),p?z(L):u}function F(L){var X=L-g,fe=L-h,be=t-X;return k?oi(be,s-fe):be}function y(L){var X=L-g,fe=L-h;return g===void 0||X>=t||X<0||k&&fe>=s}function S(){var L=It();if(y(L))return w(L);a=setTimeout(S,F(L))}function w(L){return a=void 0,B&&l?z(L):(l=i=void 0,u)}function j(){a!==void 0&&clearTimeout(a),h=0,l=g=i=a=void 0}function D(){return a===void 0?u:w(It())}function $(){var L=It(),X=y(L);if(l=arguments,i=this,g=L,X){if(a===void 0)return T(g);if(k)return clearTimeout(a),a=setTimeout(S,t),z(g)}return a===void 0&&(a=setTimeout(S,t)),u}return $.cancel=j,$.flush=D,$}var ai="Expected a function";function Bt(e,t,n){var l=!0,i=!0;if(typeof e!="function")throw new TypeError(ai);return gt(n)&&(l="leading"in n?!!n.leading:l,i="trailing"in n?!!n.trailing:i),ii(e,t,{leading:l,maxWait:t,trailing:i})}const li=se({name:"Checkmark",render(){return r("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 16 16"},r("g",{fill:"none"},r("path",{d:"M14.046 3.486a.75.75 0 0 1-.032 1.06l-7.93 7.474a.85.85 0 0 1-1.188-.022l-2.68-2.72a.75.75 0 1 1 1.068-1.053l2.234 2.267l7.468-7.038a.75.75 0 0 1 1.06.032z",fill:"currentColor"})))}}),ri=se({name:"Empty",render(){return r("svg",{viewBox:"0 0 28 28",fill:"none",xmlns:"http://www.w3.org/2000/svg"},r("path",{d:"M26 7.5C26 11.0899 23.0899 14 19.5 14C15.9101 14 13 11.0899 13 7.5C13 3.91015 15.9101 1 19.5 1C23.0899 1 26 3.91015 26 7.5ZM16.8536 4.14645C16.6583 3.95118 16.3417 3.95118 16.1464 4.14645C15.9512 4.34171 15.9512 4.65829 16.1464 4.85355L18.7929 7.5L16.1464 10.1464C15.9512 10.3417 15.9512 10.6583 16.1464 10.8536C16.3417 11.0488 16.6583 11.0488 16.8536 10.8536L19.5 8.20711L22.1464 10.8536C22.3417 11.0488 22.6583 11.0488 22.8536 10.8536C23.0488 10.6583 23.0488 10.3417 22.8536 10.1464L20.2071 7.5L22.8536 4.85355C23.0488 4.65829 23.0488 4.34171 22.8536 4.14645C22.6583 3.95118 22.3417 3.95118 22.1464 4.14645L19.5 6.79289L16.8536 4.14645Z",fill:"currentColor"}),r("path",{d:"M25 22.75V12.5991C24.5572 13.0765 24.053 13.4961 23.5 13.8454V16H17.5L17.3982 16.0068C17.0322 16.0565 16.75 16.3703 16.75 16.75C16.75 18.2688 15.5188 19.5 14 19.5C12.4812 19.5 11.25 18.2688 11.25 16.75L11.2432 16.6482C11.1935 16.2822 10.8797 16 10.5 16H4.5V7.25C4.5 6.2835 5.2835 5.5 6.25 5.5H12.2696C12.4146 4.97463 12.6153 4.47237 12.865 4H6.25C4.45507 4 3 5.45507 3 7.25V22.75C3 24.5449 4.45507 26 6.25 26H21.75C23.5449 26 25 24.5449 25 22.75ZM4.5 22.75V17.5H9.81597L9.85751 17.7041C10.2905 19.5919 11.9808 21 14 21L14.215 20.9947C16.2095 20.8953 17.842 19.4209 18.184 17.5H23.5V22.75C23.5 23.7165 22.7165 24.5 21.75 24.5H6.25C5.2835 24.5 4.5 23.7165 4.5 22.75Z",fill:"currentColor"}))}}),si=se({props:{onFocus:Function,onBlur:Function},setup(e){return()=>r("div",{style:"width: 0; height: 0",tabindex:0,onFocus:e.onFocus,onBlur:e.onBlur})}}),di=c("empty",`
 display: flex;
...
`,[P("segment-type",[c("tabs-rail",[Z("&.transition-disabled",[c("tabs-capsule",`
 ...
 `),c("tabs-pad",`
 border-top: 1px solid var(--n-tab-border-color);
 `)])])])]),_i=Object.assign(Object.assign({},ye.props),{value:[String,Number],defaultValue:[String,Number],trigger:{type:String,default:"click"},type:{type:String,default:"bar"},closable:Boolean,justifyContent:String,size:{type:String,default:"medium"},placement:{type:String,default:"top"},tabStyle:[String,Object],tabClass:String,addTabStyle:[String,Object],addTabClass:String,barWidth:Number,paneClass:String,paneStyle:[String,Object],paneWrapperClass:String,paneWrapperStyle:[String,Object],addable:[Boolean,Object],tabsPadding:{type:Number,default:0},animated:Boolean,onBeforeLeave:Function,onAdd:Function,"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],onClose:[Function,Array],labelSize:String,activeName:[String,Number],onActiveNameChange:[Function,Array]}),Pi=se({name:"Tabs",props:_i,setup(e,{slots:t}){var n,l,i,s;const{mergedClsPrefixRef:u,inlineThemeDisabled:a}=ot(e),g=ye("Tabs","-tabs",zi,So,e,u),h=O(null),p=O(null),k=O(null),B=O(null),z=O(null),T=O(null),F=O(!0),y=O(!0),S=Wt(e,["labelSize","size"]),w=Wt(e,["activeName","value"]),j=O((l=(n=w.value)!==null&&n!==void 0?n:e.defaultValue)!==null&&l!==void 0?l:t.default?(s=(i=kt(t.default())[0])===null||i===void 0?void 0:i.props)===null||s===void 0?void 0:s.name:null),D=Nt(w,j),$={id:0},L=W(()=>{if(!(!e.justifyContent||e.type==="card"))return{display:"flex",justifyContent:e.justifyContent}});$e(D,()=>{$.id=0,C(),M()});function X(){var f;const{value:b}=D;return b===null?null:(f=h.value)===null||f===void 0?void 0:f.querySelector(`[data-name="${b}"]`)}function fe(f){if(e.type==="card")return;const{value:b}=p;if(!b)return;const _=b.style.opacity==="0";if(f){const I=`${u.value}-tabs-bar--disabled`,{barWidth:d,placement:x}=e;if(f.dataset.disabled==="true"?b.classList.add(I):b.classList.remove(I),["top","bottom"].includes(x)){if(ve(["top","maxHeight","height"]),typeof d=="number"&&f.offsetWidth>=d){const J=Math.floor((f.offsetWidth-d)/2)+f.offsetLeft;b.style.left=`${J}px`,b.style.maxWidth=`${d}px`}else b.style.left=`${f.offsetLeft}px`,b.style.maxWidth=`${f.offsetWidth}px`;b.style.width="8192px",_&&(b.style.transition="none"),b.offsetWidth,_&&(b.style.transition="",b.style.opacity="1")}else{if(ve(["left","maxWidth","width"]),typeof d=="number"&&f.offsetHeight>=d){const J=Math.floor((f.offsetHeight-d)/2)+f.offsetTop;b.style.top=`${J}px`,b.style.maxHeight=`${d}px`}else b.style.top=`${f.offsetTop}px`,b.style.maxHeight=`${f.offsetHeight}px`;b.style.height="8192px",_&&(b.style.transition="none"),b.offsetHeight,_&&(b.style.transition="",b.style.opacity="1")}}}function be(){if(e.type==="card")return;const{value:f}=p;f&&(f.style.opacity="0")}function ve(f){const{value:b}=p;if(b)for(const _ of f)b.style[_]=""}function C(){if(e.type==="card")return;const f=X();f?fe(f):be()}function M(){var f;const b=(f=z.value)===null||f===void 0?void 0:f.$el;if(!b)return;const _=X();if(!_)return;const{scrollLeft:I,offsetWidth:d}=b,{offsetLeft:x,offsetWidth:J}=_;I>x?b.scrollTo({top:0,left:x,behavior:"smooth"}):x+J>I+d&&b.scrollTo({top:0,left:x+J-d,behavior:"smooth"})}const E=O(null);let Y=0,q=null;function Q(f){const b=E.value;if(b){Y=f.getBoundingClientRect().height;const _=`${Y}px`,I=()=>{b.style.height=_,b.style.maxHeight=_};q?(I(),q(),q=null):q=I}}function ee(f){const b=E.value;if(b){const _=f.getBoundingClientRect().height,I=()=>{document.body.offsetHeight,b.style.maxHeight=`${_}px`,b.style.height=`${Math.max(Y,_)}px`};q?(q(),q=null,I()):q=I}}function te(){const f=E.value;if(f){f.style.maxHeight="",f.style.height="";const{paneWrapperStyle:b}=e;if(typeof b=="string")f.style.cssText=b;else if(b){const{maxHeight:_,height:I}=b;_!==void 0&&(f.style.maxHeight=_),I!==void 0&&(f.style.height=I)}}}const ce={value:[]},ae=O("next");function ue(f){const b=D.value;let _="next";for(const I of ce.value){if(I===b)break;if(I===f){_="prev";break}}ae.value=_,v(f)}function v(f){const{onActiveNameChange:b,onUpdateValue:_,"onUpdate:value":I}=e;b&&ge(b,f),_&&ge(_,f),I&&ge(I,f),j.value=f}function R(f){const{onClose:b}=e;b&&ge(b,f)}function oe(){const{value:f}=p;if(!f)return;const b="transition-disabled";f.classList.add(b),C(),f.classList.remove(b)}const he=O(null);function Se({transitionDisabled:f}){const b=h.value;if(!b)return;f&&b.classList.add("transition-disabled");const _=X();_&&he.value&&(he.value.style.width=`${_.offsetWidth}px`,he.value.style.height=`${_.offsetHeight}px`,he.value.style.transform=`translateX(${_.offsetLeft-pt(getComputedStyle(b).paddingLeft)}px)`,f&&he.value.offsetWidth),f&&b.classList.remove("transition-disabled")}$e([D],()=>{e.type==="segment"&&Je(()=>{Se({transitionDisabled:!1})})}),nt(()=>{e.type==="segment"&&Se({transitionDisabled:!0})});let _e=0;function we(f){var b;if(f.contentRect.width===0&&f.contentRect.height===0||_e===f.contentRect.width)return;_e=f.contentRect.width;const{type:_}=e;if((_==="line"||_==="bar")&&oe(),_!=="segment"){const{placement:I}=e;Pe((I==="top"||I==="bottom"?(b=z.value)===null||b===void 0?void 0:b.$el:T.value)||null)}}const pe=Bt(we,64);$e([()=>e.justifyContent,()=>e.size],()=>{Je(()=>{const{type:f}=e;(f==="line"||f==="bar")&&oe()})});const Ce=O(!1);function Re(f){var b;const{target:_,contentRect:{width:I}}=f,d=_.parentElement.offsetWidth;if(!Ce.value)d<I&&(Ce.value=!0);else{const{value:x}=B;if(!x)return;d-I>x.$el.offsetWidth&&(Ce.value=!1)}Pe(((b=z.value)===null||b===void 0?void 0:b.$el)||null)}const Be=Bt(Re,64);function Ee(){const{onAdd:f}=e;f&&f(),Je(()=>{const b=X(),{value:_}=z;!b||!_||_.scrollTo({left:b.offsetLeft,top:0,behavior:"smooth"})})}function Pe(f){if(!f)return;const{placement:b}=e;if(b==="top"||b==="bottom"){const{scrollLeft:_,scrollWidth:I,offsetWidth:d}=f;F.value=_<=0,y.value=_+d>=I}else{const{scrollTop:_,scrollHeight:I,offsetHeight:d}=f;F.value=_<=0,y.value=_+d>=I}}const Le=Bt(f=>{Pe(f.target)},64);At(qt,{triggerRef:ne(e,"trigger"),tabStyleRef:ne(e,"tabStyle"),tabClassRef:ne(e,"tabClass"),addTabStyleRef:ne(e,"addTabStyle"),addTabClassRef:ne(e,"addTabClass"),paneClassRef:ne(e,"paneClass"),paneStyleRef:ne(e,"paneStyle"),mergedClsPrefixRef:u,typeRef:ne(e,"type"),closableRef:ne(e,"closable"),valueRef:D,tabChangeIdRef:$,onBeforeLeaveRef:ne(e,"onBeforeLeave"),activateTab:ue,handleClose:R,handleAdd:Ee}),Ro(()=>{C(),M()}),wn(()=>{const{value:f}=k;if(!f)return;const{value:b}=u,_=`${b}-tabs-nav-scroll-wrapper--shadow-start`,I=`${b}-tabs-nav-scroll-wrapper--shadow-end`;F.value?f.classList.remove(_):f.classList.add(_),y.value?f.classList.remove(I):f.classList.add(I)});const ke={syncBarPosition:()=>{C()}},Oe=()=>{Se({transitionDisabled:!0})},Me=W(()=>{const{value:f}=S,{type:b}=e,_={card:"Card",bar:"Bar",line:"Line",segment:"Segment"}[b],I=`${f}${_}`,{self:{barColor:d,closeIconColor:x,closeIconColorHover:J,closeIconColorPressed:Ve,tabColor:Ke,tabBorderColor:We,paneTextColor:De,tabFontWeight:je,tabBorderRadius:Ue,tabFontWeightActive:qe,colorSegment:He,fontWeightStrong:Te,tabColorSegment:o,closeSize:m,closeIconSize:A,closeColorHover:U,closeColorPressed:K,closeBorderRadius:V,[de("panePadding",f)]:H,[de("tabPadding",I)]:le,[de("tabPaddingVertical",I)]:xe,[de("tabGap",I)]:yt,[de("tabGap",`${I}Vertical`)]:wt,[de("tabTextColor",b)]:Ct,[de("tabTextColorActive",b)]:St,[de("tabTextColorHover",b)]:Rt,[de("tabTextColorDisabled",b)]:Tt,[de("tabFontSize",f)]:zt},common:{cubicBezierEaseInOut:_t}}=g.value;return{"--n-bezier":_t,"--n-color-segment":He,"--n-bar-color":d,"--n-tab-font-size":zt,"--n-tab-text-color":Ct,"--n-tab-text-color-active":St,"--n-tab-text-color-disabled":Tt,"--n-tab-text-color-hover":Rt,"--n-pane-text-color":De,"--n-tab-border-color":We,"--n-tab-border-radius":Ue,"--n-close-size":m,"--n-close-icon-size":A,"--n-close-color-hover":U,"--n-close-color-pressed":K,"--n-close-border-radius":V,"--n-close-icon-color":x,"--n-close-icon-color-hover":J,"--n-close-icon-color-pressed":Ve,"--n-tab-color":Ke,"--n-tab-font-weight":je,"--n-tab-font-weight-active":qe,"--n-tab-padding":le,"--n-tab-padding-vertical":xe,"--n-tab-gap":yt,"--n-tab-gap-vertical":wt,"--n-pane-padding-left":Fe(H,"left"),"--n-pane-padding-right":Fe(H,"right"),"--n-pane-padding-top":Fe(H,"top"),"--n-pane-padding-bottom":Fe(H,"bottom"),"--n-font-weight-strong":Te,"--n-tab-color-segment":o}}),me=a?at("tabs",W(()=>`${S.value[0]}${e.type[0]}`),Me,e):void 0;return Object.assign({mergedClsPrefix:u,mergedValue:D,renderedNames:new Set,segmentCapsuleElRef:he,tabsPaneWrapperRef:E,tabsElRef:h,barElRef:p,addTabInstRef:B,xScrollInstRef:z,scrollWrapperElRef:k,addTabFixed:Ce,tabWrapperStyle:L,handleNavResize:pe,mergedSize:S,handleScroll:Le,handleTabsResize:Be,cssVars:a?void 0:Me,themeClass:me==null?void 0:me.themeClass,animationDirection:ae,renderNameListRef:ce,yScrollElRef:T,handleSegmentResize:Oe,onAnimationBeforeLeave:Q,onAnimationEnter:ee,onAnimationAfterEnter:te,onRender:me==null?void 0:me.onRender},ke)},render(){const{mergedClsPrefix:e,type:t,placement:n,addTabFixed:l,addable:i,mergedSize:s,renderNameListRef:u,onRender:a,paneWrapperClass:g,paneWrapperStyle:h,$slots:{default:p,prefix:k,suffix:B}}=this;a==null||a();const z=p?kt(p()).filter($=>$.type.__TAB_PANE__===!0):[],T=p?kt(p()).filter($=>$.type.__TAB__===!0):[],F=!T.length,y=t==="card",S=t==="segment",w=!y&&!S&&this.justifyContent;u.value=[];const j=()=>{const $=r("div",{style:this.tabWrapperStyle,class:[`${e}-tabs-wrapper`]},w?null:r("div",{class:`${e}-tabs-scroll-padding`,style:{width:`${this.tabsPadding}px`}}),F?z.map((L,X)=>(u.value.push(L.props.name),Lt(r(jt,Object.assign({},L.props,{internalCreatedByPane:!0,internalLeftPadded:X!==0&&(!w||w==="center"||w==="start"||w==="end")}),L.children?{default:L.children.tab}:void 0)))):T.map((L,X)=>(u.value.push(L.props.name),Lt(X!==0&&!w?fn(L):L))),!l&&i&&y?un(i,(F?z.length:T.length)!==0):null,w?null:r("div",{class:`${e}-tabs-scroll-padding`,style:{width:`${this.tabsPadding}px`}}));return r("div",{ref:"tabsElRef",class:`${e}-tabs-nav-scroll-content`},y&&i?r(Ye,{onResize:this.handleTabsResize},{default:()=>$}):$,y?r("div",{class:`${e}-tabs-pad`}):null,y?null:r("div",{ref:"barElRef",class:`${e}-tabs-bar`}))},D=S?"top":n;return r("div",{class:[`${e}-tabs`,this.themeClass,`${e}-tabs--${t}-type`,`${e}-tabs--${s}-size`,w&&`${e}-tabs--flex`,`${e}-tabs--${D}`],style:this.cssVars},r("div",{class:[`${e}-tabs-nav--${t}-type`,`${e}-tabs-nav--${D}`,`${e}-tabs-nav`]},mt(k,$=>$&&r("div",{class:`${e}-tabs-nav__prefix`},$)),S?r(Ye,{onResize:this.handleSegmentResize},{default:()=>r("div",{class:`${e}-tabs-rail`,ref:"tabsElRef"},r("div",{class:`${e}-tabs-capsule`,ref:"segmentCapsuleElRef"},r("div",{class:`${e}-tabs-wrapper`},r("div",{class:`${e}-tabs-tab`}))),F?z.map(($,L)=>(u.value.push($.props.name),r(jt,Object.assign({},$.props,{internalCreatedByPane:!0,internalLeftPadded:L!==0}),$.children?{default:$.children.tab}:void 0))):T.map(($,L)=>(u.value.push($.props.name),L===0?$:fn($))))}):r(Ye,{onResize:this.handleNavResize},{default:()=>r("div",{class:`${e}-tabs-nav-scroll-wrapper`,ref:"scrollWrapperElRef"},["top","bottom"].includes(D)?r(Uo,{ref:"xScrollInstRef",onScroll:this.handleScroll},{default:j}):r("div",{class:`${e}-tabs-nav-y-scroll`,onScroll:this.handleScroll,ref:"yScrollElRef"},j()))}),l&&i&&y?un(i,!0):null,mt(B,$=>$&&r("div",{class:`${e}-tabs-nav__suffix`},$))),F&&(this.animated&&(D==="top"||D==="bottom")?r("div",{ref:"tabsPaneWrapperRef",style:h,class:[`${e}-tabs-pane-wrapper`,g]},cn(z,this.mergedValue,this.renderedNames,this.onAnimationBeforeLeave,this.onAnimationEnter,this.onAnimationAfterEnter,this.animationDirection)):cn(z,this.mergedValue,this.renderedNames)))}});function cn(e,t,n,l,i,s,u){const a=[];return e.forEach(g=>{const{name:h,displayDirective:p,"display-directive":k}=g.props,B=T=>p===T||k===T,z=t===h;if(g.key!==void 0&&(g.key=h),z||B("show")||B("show:lazy")&&n.has(h)){n.has(h)||n.add(h);const T=!B("if");a.push(T?Cn(g,[[Sn,z]]):g)}}),u?r(To,{name:`${u}-transition`,onBeforeLeave:l,onEnter:i,onAfterEnter:s},{default:()=>a}):a}function un(e,t){return r(jt,{ref:"addTabInstRef",key:"__addable",name:"__addable",internalCreatedByPane:!0,internalAddable:!0,internalLeftPadded:t,disabled:typeof e=="object"&&e.disabled})}function fn(e){const t=zo(e);return t.props?t.props.internalLeftPadded=!0:t.props={internalLeftPadded:!0},t}function Lt(e){return Array.isArray(e.dynamicProps)?e.dynamicProps.includes("internalLeftPadded")||e.dynamicProps.push("internalLeftPadded"):e.dynamicProps=["internalLeftPadded"],e}const ki={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512"},Oi=Ie("path",{d:"M289.94 256l95-95A24 24 0 0 0 351 127l-95 95l-95-95a24 24 0 0 0-34 34l95 95l-95 95a24 24 0 1 0 34 34l95-95l95 95a24 24 0 0 0 34-34z",fill:"currentColor"},null,-1),Fi=[Oi],$i=se({name:"Close",render:function(t,n){return ze(),Ne("svg",ki,Fi)}}),Mi={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512"},Ii=Ie("path",{d:"M434.67 285.59v-29.8c0-98.73-80.24-178.79-179.2-178.79a179 179 0 0 0-140.14 67.36m-38.53 82v29.8C76.8 355 157 435 256 435a180.45 180.45 0 0 0 140-66.92",fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"32"},null,-1),Bi=Ie("path",{fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"32",d:"M32 256l44-44l46 44"},null,-1),Ei=Ie("path",{fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"32",d:"M480 256l-44 44l-46-44"},null,-1),Li=[Ii,Bi,Ei],Ai=se({name:"Sync",render:function(t,n){return ze(),Ne("svg",Mi,Li)}}),Ni={class:"moduls-scroll-section"},Wi=se({__name:"Scroll",props:{dynamic:{type:Boolean}},emits:["bottomReached"],setup(e,{emit:t}){const n=e,l=t,i=O();function s(){const a=i.value;function g(){if(a){const h=a.clientHeight<a.scrollHeight?"var(--moduls-scroll-padding)":"0";a.style.paddingRight=h;const p=a.clientWidth<a.scrollWidth?"var(--moduls-scroll-padding)":"0";a.style.paddingBottom=p}}a?(g(),n.dynamic&&new ResizeObserver(g).observe(a)):requestAnimationFrame(s)}s();const u=_o(a=>l("bottomReached",a));return(a,g)=>(ze(),Ne("section",Ni,[Ie("div",{ref_key:"ScrollDom",ref:i,class:"moduls-scroll",onScroll:g[0]||(g[0]=(...h)=>G(u)&&G(u)(...h))},[Ie("div",null,[bt(a.$slots,"default",{},void 0,!0)])],544)]))}}),bn=Ut(Wi,[["__scopeId","data-v-d9097fdd"]]),Di={class:"popup-layout"},ji=se({__name:"Popup",emits:["Closure"],setup(e,{emit:t}){const n=t;return(l,i)=>(ze(),Ne("section",Di,[Ie("header",null,[re(G(Ri),null,{default:ie(()=>[bt(l.$slots,"header",{},void 0,!0)]),_:3}),re(G(ht),null,{default:ie(()=>[bt(l.$slots,"tool",{},void 0,!0),Ie("div",{class:"clickable",onClick:i[0]||(i[0]=s=>n("Closure"))},[re(G(vt),{size:"22",component:G($i)},null,8,["component"])])]),_:3})]),bt(l.$slots,"default",{},void 0,!0)]))}}),Hi=Ut(ji,[["__scopeId","data-v-abb3a2ef"]]),Vi=se({__name:"index",emits:["Closure"],setup(e,{emit:t}){const n=t;function l(){ko(),n("Closure")}Po([".Settings.center-positioning"],l);const i=O(),s=O(),u=W(()=>{const a=Lo.value.components.popups.settings;return s.value&&(i.value=a.tabs[0].name,requestAnimationFrame(()=>{s.value.syncBarPosition()})),a});return(a,g)=>(ze(),Ot(Hi,{class:"Settings center-positioning",onClosure:l},{header:ie(()=>[Ge(Xe(u.value.header),1)]),default:ie(()=>[re(G(Pi),{ref_key:"tabsRef",ref:s,value:i.value,"onUpdate:value":g[2]||(g[2]=h=>i.value=h),animated:!0},{default:ie(()=>[re(G(dn),{name:u.value.tabs[0].name},{default:ie(()=>[re(bn,null,{default:ie(()=>[re(Ft,null,{title:ie(()=>[Ge(Xe(u.value.tabs[0].items[0].title),1)]),value:ie(()=>[re(G(ln),{value:G(dt).language,"onUpdate:value":g[0]||(g[0]=h=>G(dt).language=h),options:G(Oo)},null,8,["value","options"])]),_:1}),re(Ft,null,{title:ie(()=>[Ge(Xe(u.value.tabs[0].items[1].title),1)]),value:ie(()=>[re(G(ln),{value:G(dt).theme,"onUpdate:value":g[1]||(g[1]=h=>G(dt).theme=h),options:G(Fo)},null,8,["value","options"])]),_:1})]),_:1})]),_:1},8,["name"]),re(G(dn),{name:u.value.tabs[1].name},{default:ie(()=>[re(bn,null,{default:ie(()=>[(ze(!0),Ne(et,null,Zt(G($o),h=>(ze(),Ot(Ft,{key:h.id},{title:ie(()=>[Ge(Xe(h.title),1)]),value:ie(()=>[re(G(ht),{justify:"space-between"},{default:ie(()=>[re(G(ht),null,{default:ie(()=>[re(G(ct),{quaternary:"",disabled:!h.isCustom,onClick:p=>G(Mo)(h.id)},{default:ie(()=>[re(G(vt),{size:"20",component:G(Ai)},null,8,["component"])]),_:2},1032,["disabled","onClick"]),re(G(ct),{quaternary:"",onClick:p=>G(Io)(h)},{default:ie(()=>[re(G(vt),{size:"20",component:G(Bo)("Edit")},null,8,["component"])]),_:2},1032,["onClick"])]),_:2},1024),re(G(ht),null,{default:ie(()=>[(ze(!0),Ne(et,null,Zt(h.shortcutKey,(p,k)=>(ze(),Ne(et,{key:k},[re(G(ct),null,{default:ie(()=>[Ge(Xe(p),1)]),_:2},1024),k!=h.shortcutKey.length-1?(ze(),Ot(G(ct),{key:0,bordered:!1,style:{"pointer-events":"none"}},{default:ie(()=>[re(G(vt),{size:"20",component:G(Wo)},null,8,["component"])]),_:1})):Eo("",!0)],64))),128))]),_:2},1024)]),_:2},1024)]),_:2},1024))),128))]),_:1})]),_:1},8,["name"])]),_:1},8,["value"])]),_:1}))}}),Yi=Ut(Vi,[["__scopeId","data-v-0fb11e8c"]]);export{Yi as default};
