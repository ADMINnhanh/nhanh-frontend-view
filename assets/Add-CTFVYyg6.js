...
`,[n("segment-type",[r("tabs-rail",[u("&.transition-disabled",[r("tabs-capsule",`
 ...
 `),r("tabs-pad",`
 border-top: 1px solid var(--n-tab-border-color);
 `)])])])]),Mt=Object.assign(Object.assign({},we.props),{value:[String,Number],defaultValue:[String,Number],trigger:{type:String,default:"click"},type:{type:String,default:"bar"},closable:Boolean,justifyContent:String,size:{type:String,default:"medium"},placement:{type:String,default:"top"},tabStyle:[String,Object],tabClass:String,addTabStyle:[String,Object],addTabClass:String,barWidth:Number,paneClass:String,paneStyle:[String,Object],paneWrapperClass:String,paneWrapperStyle:[String,Object],addable:[Boolean,Object],tabsPadding:{type:Number,default:0},animated:Boolean,onBeforeLeave:Function,onAdd:Function,"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],onClose:[Function,Array],labelSize:String,activeName:[String,Number],onActiveNameChange:[Function,Array]}),Jt=M({name:"Tabs",props:Mt,setup(e,{slots:s}){var b,y,d,m;const{mergedClsPrefixRef:v,inlineThemeDisabled:w}=Ct(e),C=we("Tabs","-tabs",Dt,St,e,v),h=z(null),f=z(null),j=z(null),A=z(null),g=z(null),S=z(null),x=z(!0),T=z(!0),B=ve(e,["labelSize","size"]),$=ve(e,["activeName","value"]),D=z((y=(b=$.value)!==null&&b!==void 0?b:e.defaultValue)!==null&&y!==void 0?y:s.default?(m=(d=Z(s.default())[0])===null||d===void 0?void 0:d.props)===null||m===void 0?void 0:m.name:null),P=Rt($,D),c={id:0},R=Y(()=>{if(!(!e.justifyContent||e.type==="card"))return{display:"flex",justifyContent:e.justifyContent}});ee(P,()=>{c.id=0,N(),le()});function E(){var t;const{value:a}=P;return a===null?null:(t=h.value)===null||t===void 0?void 0:t.querySelector(`[data-name="${a}"]`)}function Re(t){if(e.type==="card")return;const{value:a}=f;if(!a)return;const o=a.style.opacity==="0";if(t){const i=`${v.value}-tabs-bar--disabled`,{barWidth:p,placement:W}=e;if(t.dataset.disabled==="true"?a.classList.add(i):a.classList.remove(i),["top","bottom"].includes(W)){if(ie(["top","maxHeight","height"]),typeof p=="number"&&t.offsetWidth>=p){const I=Math.floor((t.offsetWidth-p)/2)+t.offsetLeft;a.style.left=`${I}px`,a.style.maxWidth=`${p}px`}else a.style.left=`${t.offsetLeft}px`,a.style.maxWidth=`${t.offsetWidth}px`;a.style.width="8192px",o&&(a.style.transition="none"),a.offsetWidth,o&&(a.style.transition="",a.style.opacity="1")}else{if(ie(["left","maxWidth","width"]),typeof p=="number"&&t.offsetHeight>=p){const I=Math.floor((t.offsetHeight-p)/2)+t.offsetTop;a.style.top=`${I}px`,a.style.maxHeight=`${p}px`}else a.style.top=`${t.offsetTop}px`,a.style.maxHeight=`${t.offsetHeight}px`;a.style.height="8192px",o&&(a.style.transition="none"),a.offsetHeight,o&&(a.style.transition="",a.style.opacity="1")}}}function ze(){if(e.type==="card")return;const{value:t}=f;t&&(t.style.opacity="0")}function ie(t){const{value:a}=f;if(a)for(const o of t)a.style[o]=""}function N(){if(e.type==="card")return;const t=E();t?Re(t):ze()}function le(){var t;const a=(t=g.value)===null||t===void 0?void 0:t.$el;if(!a)return;const o=E();if(!o)return;const{scrollLeft:i,offsetWidth:p}=a,{offsetLeft:W,offsetWidth:I}=o;i>W?a.scrollTo({top:0,left:W,behavior:"smooth"}):W+I>i+p&&a.scrollTo({top:0,left:W+I-p,behavior:"smooth"})}const V=z(null);let q=0,H=null;function $e(t){const a=V.value;if(a){q=t.getBoundingClientRect().height;const o=`${q}px`,i=()=>{a.style.height=o,a.style.maxHeight=o};H?(i(),H(),H=null):H=i}}function Te(t){const a=V.value;if(a){const o=t.getBoundingClientRect().height,i=()=>{document.body.offsetHeight,a.style.maxHeight=`${o}px`,a.style.height=`${Math.max(q,o)}px`};H?(H(),H=null,i()):H=i}}function Pe(){const t=V.value;if(t){t.style.maxHeight="",t.style.height="";const{paneWrapperStyle:a}=e;if(typeof a=="string")t.style.cssText=a;else if(a){const{maxHeight:o,height:i}=a;o!==void 0&&(t.style.maxHeight=o),i!==void 0&&(t.style.height=i)}}}const de={value:[]},ce=z("next");function _e(t){const a=P.value;let o="next";for(const i of de.value){if(i===a)break;if(i===t){o="prev";break}}ce.value=o,We(t)}function We(t){const{onActiveNameChange:a,onUpdateValue:o,"onUpdate:value":i}=e;a&&K(a,t),o&&K(o,t),i&&K(i,t),D.value=t}function Ae(t){const{onClose:a}=e;a&&K(a,t)}function be(){const{value:t}=f;if(!t)return;const a="transition-disabled";t.classList.add(a),N(),t.classList.remove(a)}const O=z(null);function J({transitionDisabled:t}){const a=h.value;if(!a)return;t&&a.classList.add("transition-disabled");const o=E();o&&O.value&&(O.value.style.width=`${o.offsetWidth}px`,O.value.style.height=`${o.offsetHeight}px`,O.value.style.transform=`translateX(${o.offsetLeft-Wt(getComputedStyle(a).paddingLeft)}px)`,t&&O.value.offsetWidth),t&&a.classList.remove("transition-disabled")}ee([P],()=>{e.type==="segment"&&te(()=>{J({transitionDisabled:!1})})}),zt(()=>{e.type==="segment"&&J({transitionDisabled:!0})});let fe=0;function Be(t){var a;if(t.contentRect.width===0&&t.contentRect.height===0||fe===t.contentRect.width)return;fe=t.contentRect.width;const{type:o}=e;if((o==="line"||o==="bar")&&be(),o!=="segment"){const{placement:i}=e;Q((i==="top"||i==="bottom"?(a=g.value)===null||a===void 0?void 0:a.$el:S.value)||null)}}const Le=re(Be,64);ee([()=>e.justifyContent,()=>e.size],()=>{te(()=>{const{type:t}=e;(t==="line"||t==="bar")&&be()})});const G=z(!1);function ke(t){var a;const{target:o,contentRect:{width:i}}=t,p=o.parentElement.offsetWidth;if(!G.value)p<i&&(G.value=!0);else{const{value:W}=A;if(!W)return;p-i>W.$el.offsetWidth&&(G.value=!1)}Q(((a=g.value)===null||a===void 0?void 0:a.$el)||null)}const je=re(ke,64);function Ee(){const{onAdd:t}=e;t&&t(),te(()=>{const a=E(),{value:o}=g;!a||!o||o.scrollTo({left:a.offsetLeft,top:0,behavior:"smooth"})})}function Q(t){if(!t)return;const{placement:a}=e;if(a==="top"||a==="bottom"){const{scrollLeft:o,scrollWidth:i,offsetWidth:p}=t;x.value=o<=0,T.value=o+p>=i}else{const{scrollTop:o,scrollHeight:i,offsetHeight:p}=t;x.value=o<=0,T.value=o+p>=i}}const He=re(t=>{Q(t.target)},64);$t(se,{triggerRef:L(e,"trigger"),tabStyleRef:L(e,"tabStyle"),tabClassRef:L(e,"tabClass"),addTabStyleRef:L(e,"addTabStyle"),addTabClassRef:L(e,"addTabClass"),paneClassRef:L(e,"paneClass"),paneStyleRef:L(e,"paneStyle"),mergedClsPrefixRef:v,typeRef:L(e,"type"),closableRef:L(e,"closable"),valueRef:P,tabChangeIdRef:c,onBeforeLeaveRef:L(e,"onBeforeLeave"),activateTab:_e,handleClose:Ae,handleAdd:Ee}),Tt(()=>{N(),le()}),Pt(()=>{const{value:t}=j;if(!t)return;const{value:a}=v,o=`${a}-tabs-nav-scroll-wrapper--shadow-start`,i=`${a}-tabs-nav-scroll-wrapper--shadow-end`;x.value?t.classList.remove(o):t.classList.add(o),T.value?t.classList.remove(i):t.classList.add(i)});const Ie={syncBarPosition:()=>{N()}},Oe=()=>{J({transitionDisabled:!0})},pe=Y(()=>{const{value:t}=B,{type:a}=e,o={card:"Card",bar:"Bar",line:"Line",segment:"Segment"}[a],i=`${t}${o}`,{self:{barColor:p,closeIconColor:W,closeIconColorHover:I,closeIconColorPressed:Fe,tabColor:De,tabBorderColor:Me,paneTextColor:Ne,tabFontWeight:Ve,tabBorderRadius:Ge,tabFontWeightActive:Ue,colorSegment:Xe,fontWeightStrong:Ke,tabColorSegment:Ye,closeSize:qe,closeIconSize:Je,closeColorHover:Qe,closeColorPressed:Ze,closeBorderRadius:et,[k("panePadding",t)]:U,[k("tabPadding",i)]:tt,[k("tabPaddingVertical",i)]:at,[k("tabGap",i)]:rt,[k("tabGap",`${i}Vertical`)]:ot,[k("tabTextColor",a)]:nt,[k("tabTextColorActive",a)]:st,[k("tabTextColorHover",a)]:it,[k("tabTextColorDisabled",a)]:lt,[k("tabFontSize",t)]:dt},common:{cubicBezierEaseInOut:ct}}=C.value;return{"--n-bezier":ct,"--n-color-segment":Xe,"--n-bar-color":p,"--n-tab-font-size":dt,"--n-tab-text-color":nt,"--n-tab-text-color-active":st,"--n-tab-text-color-disabled":lt,"--n-tab-text-color-hover":it,"--n-pane-text-color":Ne,"--n-tab-border-color":Me,"--n-tab-border-radius":Ge,"--n-close-size":qe,"--n-close-icon-size":Je,"--n-close-color-hover":Qe,"--n-close-color-pressed":Ze,"--n-close-border-radius":et,"--n-close-icon-color":W,"--n-close-icon-color-hover":I,"--n-close-icon-color-pressed":Fe,"--n-tab-color":De,"--n-tab-font-weight":Ve,"--n-tab-font-weight-active":Ue,"--n-tab-padding":tt,"--n-tab-padding-vertical":at,"--n-tab-gap":rt,"--n-tab-gap-vertical":ot,"--n-pane-padding-left":X(U,"left"),"--n-pane-padding-right":X(U,"right"),"--n-pane-padding-top":X(U,"top"),"--n-pane-padding-bottom":X(U,"bottom"),"--n-font-weight-strong":Ke,"--n-tab-color-segment":Ye}}),F=w?_t("tabs",Y(()=>`${B.value[0]}${e.type[0]}`),pe,e):void 0;return Object.assign({mergedClsPrefix:v,mergedValue:P,renderedNames:new Set,segmentCapsuleElRef:O,tabsPaneWrapperRef:V,tabsElRef:h,barElRef:f,addTabInstRef:A,xScrollInstRef:g,scrollWrapperElRef:j,addTabFixed:G,tabWrapperStyle:R,handleNavResize:Le,mergedSize:B,handleScroll:He,handleTabsResize:je,cssVars:w?void 0:pe,themeClass:F==null?void 0:F.themeClass,animationDirection:ce,renderNameListRef:de,yScrollElRef:S,handleSegmentResize:Oe,onAnimationBeforeLeave:$e,onAnimationEnter:Te,onAnimationAfterEnter:Pe,onRender:F==null?void 0:F.onRender},Ie)},render(){const{mergedClsPrefix:e,type:s,placement:b,addTabFixed:y,addable:d,mergedSize:m,renderNameListRef:v,onRender:w,paneWrapperClass:C,paneWrapperStyle:h,$slots:{default:f,prefix:j,suffix:A}}=this;w==null||w();const g=f?Z(f()).filter(c=>c.type.__TAB_PANE__===!0):[],S=f?Z(f()).filter(c=>c.type.__TAB__===!0):[],x=!S.length,T=s==="card",B=s==="segment",$=!T&&!B&&this.justifyContent;v.value=[];const D=()=>{const c=l("div",{style:this.tabWrapperStyle,class:[`${e}-tabs-wrapper`]},$?null:l("div",{class:`${e}-tabs-scroll-padding`,style:{width:`${this.tabsPadding}px`}}),x?g.map((R,E)=>(v.value.push(R.props.name),oe(l(ne,Object.assign({},R.props,{internalCreatedByPane:!0,internalLeftPadded:E!==0&&(!$||$==="center"||$==="start"||$==="end")}),R.children?{default:R.children.tab}:void 0)))):S.map((R,E)=>(v.value.push(R.props.name),oe(E!==0&&!$?me(R):R))),!y&&d&&T?xe(d,(x?g.length:S.length)!==0):null,$?null:l("div",{class:`${e}-tabs-scroll-padding`,style:{width:`${this.tabsPadding}px`}}));return l("div",{ref:"tabsElRef",class:`${e}-tabs-nav-scroll-content`},T&&d?l(ae,{onResize:this.handleTabsResize},{default:()=>c}):c,T?l("div",{class:`${e}-tabs-pad`}):null,T?null:l("div",{ref:"barElRef",class:`${e}-tabs-bar`}))},P=B?"top":b;return l("div",{class:[`${e}-tabs`,this.themeClass,`${e}-tabs--${s}-type`,`${e}-tabs--${m}-size`,$&&`${e}-tabs--flex`,`${e}-tabs--${P}`],style:this.cssVars},l("div",{class:[`${e}-tabs-nav--${s}-type`,`${e}-tabs-nav--${P}`,`${e}-tabs-nav`]},he(j,c=>c&&l("div",{class:`${e}-tabs-nav__prefix`},c)),B?l(ae,{onResize:this.handleSegmentResize},{default:()=>l("div",{class:`${e}-tabs-rail`,ref:"tabsElRef"},l("div",{class:`${e}-tabs-capsule`,ref:"segmentCapsuleElRef"},l("div",{class:`${e}-tabs-wrapper`},l("div",{class:`${e}-tabs-tab`}))),x?g.map((c,R)=>(v.value.push(c.props.name),l(ne,Object.assign({},c.props,{internalCreatedByPane:!0,internalLeftPadded:R!==0}),c.children?{default:c.children.tab}:void 0))):S.map((c,R)=>(v.value.push(c.props.name),R===0?c:me(c))))}):l(ae,{onResize:this.handleNavResize},{default:()=>l("div",{class:`${e}-tabs-nav-scroll-wrapper`,ref:"scrollWrapperElRef"},["top","bottom"].includes(P)?l(Ot,{ref:"xScrollInstRef",onScroll:this.handleScroll},{default:D}):l("div",{class:`${e}-tabs-nav-y-scroll`,onScroll:this.handleScroll,ref:"yScrollElRef"},D()))}),y&&d&&T?xe(d,!0):null,he(A,c=>c&&l("div",{class:`${e}-tabs-nav__suffix`},c))),x&&(this.animated&&(P==="top"||P==="bottom")?l("div",{ref:"tabsPaneWrapperRef",style:h,class:[`${e}-tabs-pane-wrapper`,C]},ge(g,this.mergedValue,this.renderedNames,this.onAnimationBeforeLeave,this.onAnimationEnter,this.onAnimationAfterEnter,this.animationDirection)):ge(g,this.mergedValue,this.renderedNames)))}});function ge(e,s,b,y,d,m,v){const w=[];return e.forEach(C=>{const{name:h,displayDirective:f,"display-directive":j}=C.props,A=S=>f===S||j===S,g=s===h;if(C.key!==void 0&&(C.key=h),g||A("show")||A("show:lazy")&&b.has(h)){b.has(h)||b.add(h);const S=!A("if");w.push(S?At(C,[[Bt,g]]):C)}}),v?l(Lt,{name:`${v}-transition`,onBeforeLeave:y,onEnter:d,onAfterEnter:m},{default:()=>w}):w}function xe(e,s){return l(ne,{ref:"addTabInstRef",key:"__addable",name:"__addable",internalCreatedByPane:!0,internalAddable:!0,internalLeftPadded:s,disabled:typeof e=="object"&&e.disabled})}function me(e){const s=kt(e);return s.props?s.props.internalLeftPadded=!0:s.props={internalLeftPadded:!0},s}function oe(e){return Array.isArray(e.dynamicProps)?e.dynamicProps.includes("internalLeftPadded")||e.dynamicProps.push("internalLeftPadded"):e.dynamicProps=["internalLeftPadded"],e}const Nt={xmlns:"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink",viewBox:"0 0 512 512"},Vt=Ce("path",{fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"32",d:"M256 112v288"},null,-1),Gt=Ce("path",{fill:"none",stroke:"currentColor","stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"32",d:"M400 256H112"},null,-1),Ut=[Vt,Gt],Qt=M({name:"Add",render:function(s,b){return jt(),Et("svg",Nt,Ut)}});export{Qt as A,Jt as N,qt as a};
